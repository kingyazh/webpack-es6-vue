import { httpuploadocr} from '../../utils/http.js'
    ...
    ctx.draw(true, () => {
      ...
      wx.canvasToTempFilePath({
        ...
        success: function (res) {
          ...
          wx.redirectTo({
            url: '/pages/visa/cardconfirm/cardconfirm?first=1&dbid=' + _this.data.dbid + '&card_type=' + _this.data.card_type + '&src=' + res.tempFilePath,
          })
        }
      })
    })
