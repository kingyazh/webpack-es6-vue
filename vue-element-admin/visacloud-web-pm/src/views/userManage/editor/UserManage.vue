    ...
    <el-container>
        <el-main class="padding-small">
            ...
            <el-row class="system_operate">
                <el-button type="primary" @click="addNewUserDialog = true">新增</el-button>
...
<script>
  ...
  import { userPagination, systemRoleList, resetPwdSystem, eidtUserState, editSystemUser, addSystemUser } from '@/api/UserManage'
  export default {
    data() {
      // 密码校验
